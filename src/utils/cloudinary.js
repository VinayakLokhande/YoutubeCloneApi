...
const uploadOnCloudinary = async (localFilePath) => {
    try {
        ...
        console.log("MY MESSAGE : file is uploaded successfully on cloudinary ", response.url)
        return response
    } catch (error) {
