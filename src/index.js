...
.then(() => {
    ...
    app.on('error', (err) => {
        console.log("MY ERROR : ERROR OCCURED IN CONNECTDB THEN ", err);
        throw err
    })
...
.catch((err) => {
    console.log("MY ERROR : MONGODB CONNECTION FAILED ", err);
})
...
30) this is video no. 9 of hitesh chaudhary channel. now app.js file madhe kam karaychay so chala tyat
